        ...
        <div class="modal-content shadow-lg">
            ...
            <div class="modal-body">
                <form id="scanStoMaterial">
                        ...
                        <div class="row g-3">
                            <div class="col-12">
                                <div class="input-group mb-4 shadow-sm rounded-3">
                                    <span class="input-group-text gradient-danger text-white fw-bold border-0 p-3"
                                        id="sto-barcode-icon">
                    ...
                    <div class="text-end">
                        <button type="button" id="submitScanSto"
                            class="btn btn-gradient-danger px-4 shadow-sm">Submit</button>
                    </div>
                </form>
            </div>
        </div>
