    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content shadow-lg">
            <div class="modal-header gradient-purple">
                <h5 class="modal-title fw-bold"><i class="bi bi-upc-scan me-2"></i>Scan Stock</h5>
                            ...
                            <div class="col-12">
                                <div class="input-group mb-4 shadow-sm rounded-3">
                                    ...
                                    <input type="text" id="mismatchInput"
                                        class="form-control form-control-lg border-0 ps-3 py-3" placeholder="Scan Stock"
                                        aria-label="Scan Mismatch" aria-describedby="mismatch-barcode-icon" autofocus>
                                </div>
                            </div>
